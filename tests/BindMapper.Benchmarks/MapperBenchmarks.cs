...
namespace BindMapper.Benchmarks;
...
/// <summary>
/// Benchmarks comparing BindMapper with AutoMapper and manual mapping.
/// </summary>
[MemoryDiagnoser]
...
public class MapperBenchmarks
{
    ...
    [Benchmark]
    public PersonDto BindMapper_Map()
    {
        return Mapper.To(_person);
    }
    ...
    [Benchmark]
    public PersonDto BindMapper_MapToExisting()
    {
        Mapper.To(_person, _personDtoReuseFlash);
